...
import type { Entry, Feed, Category } from '@/types/api';
...
export function SearchModal({
  ...
  return (
    ...
    >
      {/* Backdrop */}
      <div className="absolute inset-0 bg-black/50 backdrop-blur-sm animate-backdrop-in eink-modal-backdrop" />

      {/* Modal */}
      <div 
        className="relative w-full max-w-xl bg-[var(--color-surface-primary)] rounded-xl shadow-2xl border border-[var(--color-border-subtle)] overflow-hidden animate-slide-down eink-shell-surface eink-modal-surface"
