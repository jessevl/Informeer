                  ...
                  <div className="flex items-center gap-1">
                    {!isFullscreen && playerSize !== 'theater' && (
                      <button
                        ...
                        className="p-1.5 rounded-lg bg-black/40 hover:bg-black/60 transition-colors eink-media-action"
                        title="Minimize"
                      >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="relative">
                        ...
                        {showSpeedMenu && (
                          <div className="absolute bottom-full right-0 mb-2 py-1 rounded-lg bg-black/90 backdrop-blur shadow-lg animate-scale-in eink-media-menu">
                    ...
                    {mediaQueue.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="w-12 h-7 rounded overflow-hidden bg-[var(--color-surface-tertiary)]">
                          <FeedIcon feedId={item.entry.feed_id} iconId={item.entry.feed?.icon?.icon_id} size={48} className="w-full h-full object-cover" />
                        </div>
                        <div className="flex-1 min-w-0">
